...
import {
    NutritionService
} from '../../../database/repository.services/assets/nutrition.service';
import {
    ErrorHandler
...
import {
    NutritionValidator as validator
} from './nutrition.validator';
import {
    uuid
} from '../../../domain.types/miscellaneous/system.types';
import {
    NutritionCreateModel,
    NutritionUpdateModel,
...
export class NutritionControllerDelegate {
    ...
    _service: NutritionService = null;

    constructor() {
        this._service = new NutritionService();
    }
    ...
    search = async (request: express.Request) => {
        ...
        var filters: NutritionSearchFilters = this.getSearchFilters(request.query);
        filters = await this.authorizeSearch(request, filters);
        var searchResults: NutritionSearchResults = await this._service.search(filters);
    ...
    update = async (id: uuid, requestBody: any) => {
        ...
        const updateModel: NutritionUpdateModel = this.getUpdateModel(requestBody);
    ...
    delete = async (id: uuid) => {
        ...
        const nutritionDeleted: boolean = await this._service.delete(id);
        return {
    ...
    getUpdateModel = (requestBody): NutritionUpdateModel => {
        ...
        const updateModel: NutritionUpdateModel = {};
    ...
    authorizeSearch = async (
            ...
            searchFilters: NutritionSearchFilters): Promise<NutritionSearchFilters> => {
