...
import {
    AppointmentService
} from '../../../database/repository.services/assets/appointment.service';
import {
    ErrorHandler
...
import {
    AppointmentValidator as validator
...
export class AppointmentControllerDelegate {
    ...
    search = async (request: express.Request) => {
        ...
        var filters: AppointmentSearchFilters = this.getSearchFilters(request.query);
        filters = await this.authorizeSearch(request, filters);
        var searchResults: AppointmentSearchResults = await this._service.search(filters);
    ...
    delete = async (id: uuid) => {
        ...
        const appointmentDeleted: boolean = await this._service.delete(id);
        return {
    ...
    getSearchFilters = (query) => {
        ...
        var appointmentType = query.appointmentType ? query.appointmentType : null;
    ...
    getUpdateModel = (requestBody): AppointmentUpdateModel => {
        ...
        const updateModel: AppointmentUpdateModel = {};
        ...
        if (Helper.hasProperty(requestBody, 'AppointmentType')) {
            updateModel.AppointmentType = requestBody.AppointmentType;
        }
    ...
    authorizeSearch = async (
        ...
        searchFilters: AppointmentSearchFilters): Promise<AppointmentSearchFilters> => {
