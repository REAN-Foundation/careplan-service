...
export class CareplanCategoryController extends BaseController {
    ...
    create = async (request: express.Request, response: express.Response): Promise < void > => {
        try {
            await this.setContext('CareplanCategory.Create', request, response);
    ...
    getById = async (request: express.Request, response: express.Response): Promise < void > => {
        try {
            await this.setContext('CareplanCategory.GetById', request, response);
    ...
    search = async (request: express.Request, response: express.Response): Promise < void > => {
        try {
            await this.setContext('CareplanCategory.Search', request, response);
    ...
    update = async (request: express.Request, response: express.Response): Promise < void > => {
        try {
            await this.setContext('CareplanCategory.Update', request, response);
    ...
    delete = async (request: express.Request, response: express.Response): Promise < void > => {
        try {
            await this.setContext('CareplanCategory.Delete', request, response);
