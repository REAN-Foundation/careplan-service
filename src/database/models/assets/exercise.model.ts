...
export class ExerciseModel {
    ...
    static Schema = () => {
        ...
        return {
            ...
            ExerciseType: {
                type: Sequelize.ENUM(["Strength", "Aerobic", "Balance", "Reflexes", "Flexibility"]),
                allowNull: false,
                defaultValue: 'Aerobic'
            },
            IntensityLevel: {
                type: Sequelize.ENUM(["None", "Minimal", "Moderate", "Somewhat hard", "Hard", "Harder", "Very hard", "Extremely hard", "Maximum effort"]),
                allowNull: false,
